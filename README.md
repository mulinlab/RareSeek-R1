...
## Requirements
### Hardware
- **GPU**: NVIDIA H800 GPUs (or equivalent performance-scale GPUs, tested on 4 GPUs for inference)
### Dependencies
- Python 3.10
- PyTorch = 2.6.0
- CUDA = 12.6
