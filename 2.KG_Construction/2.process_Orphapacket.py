...
BASE_DIR = Path("/mnt/hpc/home/scllm/deepseek_model/rare_disease/new/complete/data")
INPUT_DIR = BASE_DIR / "Orphapacket"
OUTPUT_DIR = Path("/mnt/hpc/home/scllm/deepseek_model/rare_disease/new/complete/Orphapacket")
